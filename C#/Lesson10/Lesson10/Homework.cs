...
namespace Lesson10
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            //var result = debtors.Where(d => d.Email.ToLower().EndsWith("@rhyta.com") || d.Email.ToLower().EndsWith("@dayrep.com"));
            ...
            var r = debtors.GroupBy(d => d.BirthDay.Year).OrderBy(g => g.Count()).Last().Key;
            Console.WriteLine(r);
